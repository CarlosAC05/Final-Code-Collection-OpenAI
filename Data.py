...
response2 = openai.FineTune.create(training_file=fileid, model ="curie", batch_size=6, n_epochs =12,)
print(response2)
id =response2["id"]
status =None
...
#"C:/Users/kalle_6ak8nql/AppData/Local/Programs/Python/Python311/OpenAI/FineT"
...
#openai --api-key "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" api fine_tunes.list 
